...
import RangePriceItemFormField from '../components/range-price-item'
import RangeTimeItemFormField from '../components/range-time-item'
...
const RangePriceFieldForm = () => {
    ...
    useEffect(() => {
        ...
        setValue('rangeTimes', rangeTimes)
    ...
    useEffect(() => {
        ...
        setValue('rangePrices', rangePrices)
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [rangeTimesWatch])
    ...
    const onRemoveSelectedTime = (item: number) => {
        setSelectedTimes(selectedTimes.filter((number) => number !== item))
    }
    const onSetGeneralPrice = () => {
        ...
        setValue('rangePrices', newRangePrices)
    }
    return (
...
export default RangePriceFieldForm