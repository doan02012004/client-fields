...
import TypeFieldFormAdd from "../components/type-field-form"
                ...
                <div className="bg-white py-4 px-6">
                    ...
                    <div className="space-y-6 pl-5">
                        ...
                        <div className="flex">
                            ...
                            <div className="w-full">
                                <select  {...register('branchId')} id="branchId" className="px-3 py-2 border text-sm border-gray-300 w-full">
                        ...
                        <div className="flex">
                            ...
                            <div className="w-full">
                                <ReactQuill value={descriptionWatch} onChange={(content: string) => setValue('description', content)} />
